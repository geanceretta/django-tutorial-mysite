...
def create_question(question_text, days):
    ...
    (negative for questions published in the past, positive pfor questions that have yet to be published).
    """
    time = timezone.now()
...
class QuestionIndexViewTests(TestCase):
    def test_no_questions(self):
        """ If no questions exist, an appropriate massage is displayed. """
...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_recent_question(self):
        """
        was_published_recenlty() returns True for questions whose pub_date is within the last day.
        """
        time = timezone.new() - datetime.timedelta(hours=23, minutes=59, seconds=59)
